...
Detectron2 allows much easier custom data training than many other similar models, due to an easier loader function builder. It must be different for different annotation formats, but you can find the sample annotation file and loader function among the files.
